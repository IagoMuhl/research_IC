...
contains
   ...
   subroutine Ham_inter(state,J2,J3,s,m,m_prime,H_inter)
      ...
      do i = 1, maxConfig
         ...
         H_inter(i) = J1*((s(i,1)-m(1)/2)*(m_prime(6)) + (s(i,2)-m(2)/2)*(m_prime(3)) + (s(i,3)-m(3)/2)*(m_prime(14)) &
         & + (s(i,6)-m(6)/2)*(m_prime(13)) + (s(i,7)-m(7)/2)*(m_prime(6)) + (s(i,8)-m(8)/2)*(m_prime(3)) &
         & + (s(i,9)-m(9)/2)*(m_prime(14)) + (s(i,12)-m(12)/2)*(m_prime(13)) + (s(i,13)-m(13)/2)*(m_prime(6)) &
         & + (s(i,14)-m(14)/2)*(m_prime(3)) + (s(i,15)-m(15)/2)*(m_prime(14)) + (s(i,18)-m(18)/2)*(m_prime(13))) &
         & + J2*(((s(i,1)-m(1)/2) + (s(i,7)-m(7)/2) + (s(i,13)-m(13)/2))*(m_prime(13)+m_prime(7)+m_prime(5)+m_prime(3)) &
         & + ((s(i,2)-m(2)/2) + (s(i,8)-m(8)/2) + (s(i,14)-m(14)/2))*(m_prime(6)+m_prime(4)+m_prime(2)+m_prime(14)) &
         & + ((s(i,3)-m(3)/2) + (s(i,9)-m(9)/2) + (s(i,15)-m(15)/2))*(m_prime(3)+m_prime(15)+m_prime(13)) &
         & + ((s(i,4)-m(4)/2) + (s(i,10)-m(10)/2) + (s(i,16)-m(16)/2))*(m_prime(14)) & 
         & + ((s(i,5)-m(5)/2) + (s(i,11)-m(11)/2) + (s(i,17)-m(17)/2))*(m_prime(13)) & 
         & + ((s(i,6)-m(6)/2) + (s(i,12)-m(12)/2) + (s(i,18)-m(18)/2))*(m_prime(14)+m_prime(12)+m_prime(6))) &
         & + J3*(((s(i,1)-m(1)/2) + (s(i,7)-m(7)/2) + (s(i,13)-m(13)/2))*(m_prime(4)+m_prime(12)) &
         & + ((s(i,2)-m(2)/2) + (s(i,8)-m(8)/2) + (s(i,14)-m(14)/2))*(m_prime(5)+m_prime(15)) &
         & + ((s(i,3)-m(3)/2) + (s(i,9)-m(9)/2) + (s(i,15)-m(15)/2))*(m_prime(2)) & 
         & + ((s(i,4)-m(4)/2) + (s(i,10)-m(10)/2) + (s(i,16)-m(16)/2))*(m_prime(13)) &
         & + ((s(i,5)-m(5)/2) + (s(i,11)-m(11)/2) + (s(i,17)-m(17)/2))*(m_prime(14)) &
         & + ((s(i,6)-m(6)/2) + (s(i,12)-m(12)/2) + (s(i,18)-m(18)/2))*(m_prime(7)))
      ...
      do i = 1, maxConfig
         ...
         H_inter(i) = J1*((s(i,1)-m(1)/2)*(m_prime(12)) + (s(i,2)-m(2)/2)*(m_prime(9)) + (s(i,3)-m(3)/2)*(m(14)) &
         & + (s(i,6)-m(6)/2)*(m(13)) + (s(i,7)-m(7)/2)*(m_prime(18)) + (s(i,8)-m(8)/2)*(m_prime(15)) &
         & + (s(i,9)-m(9)/2)*(m_prime(2)) + (s(i,12)-m(12)/2)*(m_prime(1)) + (s(i,13)-m(13)/2)*(m(6)) &
         & + (s(i,14)-m(14)/2)*(m(3)) + (s(i,15)-m(15)/2)*(m_prime(8)) + (s(i,18)-m(18)/2)*(m_prime(7))) &
         & + J2*((s(i,1)-m(1)/2)*(m_prime(13)+m_prime(7)+m_prime(11)+m_prime(9)) &
         & + (s(i,2)-m(2)/2)*(m_prime(12)+m_prime(10)+m_prime(8)+m(14)) &
         & + (s(i,3)-m(3)/2)*(m_prime(9)+m(15)+m(13)) + (s(i,4)-m(4)/2)*(m(14)) &
         & + (s(i,5)-m(5)/2)*(m(13)) + (s(i,6)-m(6)/2)*(m(14)+m(12)+m_prime(18)) &
         & + (s(i,7)-m(7)/2)*(m(13)+m_prime(1)+m_prime(17)+m_prime(15)) &
         & + (s(i,8)-m(8)/2)*(m_prime(18)+m_prime(16)+m_prime(14)+m_prime(2)) &
         & + (s(i,9)-m(9)/2)*(m_prime(15)+m_prime(3)+m_prime(1)) &
         & + (s(i,10)-m(10)/2)*(m_prime(2)) + (s(i,11)-m(11)/2)*(m_prime(1)) &
         & + (s(i,12)-m(12)/2)*(m_prime(2)+m_prime(18)+m(6)) &
         & + (s(i,13)-m(13)/2)*(m_prime(1)+m(7)+m(5)+m(3)) &
         & + (s(i,14)-m(14)/2)*(m(6)+m(4)+m(2)+m_prime(8)) &
         & + (s(i,15)-m(15)/2)*(m(3)+m_prime(9)+m_prime(7)) &
         & + (s(i,16)-m(16)/2)*(m_prime(8)) + (s(i,17)-m(17)/2)*(m_prime(7)) &
         & + (s(i,18)-m(18)/2)*(m_prime(8)+m_prime(6)+m_prime(12))) &
         & + J3*((s(i,1)-m(1)/2)*(m_prime(6)+m_prime(10)) &
         & + (s(i,2)-m(2)/2)*(m_prime(11)+m(15)) &
         & + (s(i,3)-m(3)/2)*(m_prime(8)) + (s(i,4)-m(4)/2)*(m(13)) &
         & + (s(i,5)-m(5)/2)*(m(14)) + (s(i,6)-m(6)/2)*(m_prime(1)) &
         & + (s(i,7)-m(7)/2)*(m(12)+m_prime(16)) &
         & + (s(i,8)-m(8)/2)*(m_prime(17)+m_prime(3)) &
         & + (s(i,9)-m(9)/2)*(m_prime(14)) &
         & + (s(i,10)-m(10)/2)*(m_prime(1)) + (s(i,11)-m(11)/2)*(m_prime(2)) &
         & + (s(i,12)-m(12)/2)*(m(7)) &
         & + (s(i,13)-m(13)/2)*(m_prime(18)+m(4)) &
         & + (s(i,14)-m(14)/2)*(m(5)+m_prime(9)) &
         & + (s(i,15)-m(15)/2)*(m(2)) &
         & + (s(i,16)-m(16)/2)*(m_prime(7)) + (s(i,17)-m(17)/2)*(m_prime(8)) &
         & + (s(i,18)-m(18)/2)*(m_prime(13)))
      enddo
