...
contains
   ...
   subroutine HAM_INTRA(J2,s,H_intra,N)
      ...
      do i = 1, maxConfig
         ...
         N(i,1) = J1*(2*s(i,6)+2*s(i,14)) + J2*(s(i,1)+s(i,5)+s(i,7)+s(i,9)+s(i,13)+s(i,15))
         ...
         N(i,6) = J1*(2*s(i,1)+2*s(i,9)) + J2*(s(i,2)+s(i,6)+s(i,8)+s(i,10)+s(i,14)+s(i,16))
   ...
   subroutine Ham_inter_state(J2,N,m,H_inter)
      ...
      do i = 1, maxConfig
         ...
         ! (s(i,1)*m(6)+s(i,14)*m(1)-m(1)*m(6)) + &
         ! (s(i,2)*m(5)+s(i,13)*m(2)-m(2)*m(5)) + &
         ! (s(i,3)*m(4)+s(i,12)*m(3)-m(3)*m(4)) + &
         ! (s(i,4)*m(3)+s(i,11)*m(4)-m(4)*m(3)) + &
         ! (s(i,5)*m(2)+s(i,10)*m(5)-m(5)*m(2)) + &
         ! (s(i,6)*m(1)+s(i,9)*m(6)-m(6)*m(1)) + &
         ! (s(i,7)*m(8)+s(i,16)*m(7)-m(7)*m(8)) + &
         ! (s(i,8)*m(7)+s(i,15)*m(8)-m(8)*m(7)) + &
         ! (s(i,9)*m(6)+s(i,14)*m(1)-m(1)*m(6))) + &

         ! J2*((s(i,1)*m(1)+s(i,9)*m(1)-m(1)*m(1)) + &
         ! (s(i,1)*m(5)+s(i,13)*m(1)-m(1)*m(5)) + &
         ! (s(i,2)*m(6)+s(i,14)*m(2)-m(2)*m(6)) + &
         ! (s(i,2)*m(4)+s(i,12)*m(2)-m(2)*m(4)) + &
         ! (s(i,3)*m(5)+s(i,13)*m(3)-m(3)*m(5)) + &
         ! (s(i,3)*m(3)+s(i,11)*m(3)-m(3)*m(3)) + &
         ! (s(i,4)*m(4)+s(i,12)*m(4)-m(4)*m(4)) + &
         ! (s(i,4)*m(2)+s(i,10)*m(4)-m(4)*m(2)) + &
         ! (s(i,5)*m(3)+s(i,11)*m(5)-m(5)*m(3)) + &
         ! (s(i,5)*m(1)+s(i,9)*m(5)-m(5)*m(1)) + &
         ! (s(i,10)*m(6)+s(i,6)*m(2)-m(6)*m(2)) + &
         ! (s(i,6)*m(6)+s(i,14)*m(6)-m(6)*m(6)) + &
         ! (s(i,6)*m(8)+s(i,16)*m(6)-m(6)*m(8)) + &
         ! (s(i,7)*m(1)+s(i,1)*m(7)-m(1)*m(7)) + &
         ! (s(i,7)*m(7)+s(i,15)*m(7)-m(7)*m(7)) + &
         ! (s(i,8)*m(8)+s(i,16)*m(8)-m(8)*m(8)) + &
         ! (s(i,8)*m(6)+s(i,14)*m(8)-m(8)*m(6)) + &
         ! (s(i,9)*m(7)+s(i,15)*m(1)-m(1)*m(7)))
         ...
         H_inter(i) = m(1)*(N(i,1)) + m(2)*N(i,2) + m(3)*(N(i,3)) + m(4)*(N(i,4)) &
          + m(5)*N(i,5) + m(6)*(N(i,6)) + m(7)*(N(i,7)) + m(8)*(N(i,8)) - &
             ...
             2*J2*((m(1)*m(5) + m(2)*m(6) + m(2)*m(4) + m(3)*m(5) + m(6)*m(8) + m(1)*m(7))) + &
             J2*(m(1)**2 + m(3)**2 + m(4)**2 + m(6)**2 + m(7)**2 + m(8)**2))
   ...
   subroutine order_parameter(state,m,m_order)
      ...
      select case(state)
       ...
       case('AF')
         ...
         !m_order = (m(1)-m(2)+m(3)-m(4)+m(5)-m(6)+m(7)-m(8)+2*m(1)-2*m(2))
