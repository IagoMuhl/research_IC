...
set encoding utf8
set output 'DiagramaDimmer(J3=0.1).png'
...
#Ponto Crítico
set label 4 at 0.65, 2.0
set label 4 "0.72" tc rgb '#8313E8'
...
plot AF using ($1<=0.429?$1:2/0):2 w l ls 3, \
    SAF using ($1>=0.72?$1:2/0):2 w l ls 3, \
    SD using ($1>=0.43?$1:2/0):2 w l ls 3 dt 2, \
