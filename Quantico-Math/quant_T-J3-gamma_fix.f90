program quant_T_J3_gamma
    ...
    real*8 :: Z, T, J2_final, step, m, tol, erro, m_guess, J2, F_helm, F_prime
 ...
 !---------------------------------------------------------
    ...
    do
      ...
      !     read(*,*) T
          ...
          print*, 'Entre com Gamma, step'
          read(*,*)   Gamma, cd

          print*, 'Entre com a J2'
          read(*,*)   J2

          print*, 'Entre com a J2_final '
          read(*,*)   J2_final
 ...
 !------------------------ OPEN UNIT -----------------
    ...
    open(unit=20, file=trim(state) // "_T_J2-F-m.dat")
